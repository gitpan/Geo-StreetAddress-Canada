# This Makefile is for the Geo::StreetAddress::Canada extension to perl.
#
...
#     AUTHOR => [q[Scott Burlovich <teedot@gmail.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Geo::StreetAddress::Canada]
#     PREREQ_PM => { Class::Data::Inheritable=>q[0.04] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[Canada.pm]
...
NAME_SYM = Geo_StreetAddress_Canada
VERSION = 1.00
...
MAKE = make
FULLEXT = Geo/StreetAddress/Canada
BASEEXT = Canada
PARENT_NAME = Geo::StreetAddress
DLBASE = $(BASEEXT)
VERSION_FROM = Canada.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
INST_LIBDIR      = $(INST_LIB)/Geo/StreetAddress
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Geo/StreetAddress
...
TO_INST_PM = Canada.pm

PM_TO_BLIB = Canada.pm \
	$(INST_LIB)/Geo/StreetAddress/Canada.pm
...
DISTNAME = Geo-StreetAddress-Canada
DISTVNAME = Geo-StreetAddress-Canada-1.00
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  Canada.pm $(INST_MAN3DIR)/Geo::StreetAddress::Canada.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Scott Burlovich <teedot@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Geo-StreetAddress-Canada' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Scott Burlovich <teedot@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Geo-StreetAddress-Canada",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Class::Data::Inheritable" : "0.04"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Scott Burlovich &lt;teedot@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Class::Data::Inheritable" VERSION="0.04" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  Canada.pm $(INST_LIB)/Geo/StreetAddress/Canada.pm 
